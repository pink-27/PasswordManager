    ...
    <div className="password-card">
      {isEditing ? (
        <>
          ...
          />
          <button onClick={handleSave} className="toggle-button">Save</button>
        </>
      ) : (
        <>
          ...
          <button className="toggle-button" onClick={handleEdit}>Edit</button>
          <button className="toggle-button" onClick={handleDelete}>Delete</button>
          <button onClick={togglePasswordVisibility} className="toggle-button m-2">
